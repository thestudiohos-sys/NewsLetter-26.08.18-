...
const optionalImagePath = (label: string) =>
  z
...
const productSchema = z.strictObject({
  ...
  mainImage: optionalImagePath("상품 대표 이미지"),
  secondaryImage: optionalImagePath("상품 보조 이미지"),
...
export const smartStoreInputSchema = z.strictObject({
  ...
  heroImage: optionalImagePath("Hero 이미지"),
